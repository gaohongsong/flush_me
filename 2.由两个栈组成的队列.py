...
class Stack(list):
    ...
    def peek(self):
        super(Stack, self).__getitem__(-1)

    def is_empty(self):
        return super(Stack, self).__len__() == 0
...
if __name__ == '__main__':
    ...
    [17, 3, 13] [17, 3, 13]
    [17, 3, 13, 1] [17, 3, 13, 1]
    [17, 3, 13, 1, 11] [17, 3, 13, 1, 11]
    =======================================
    [17, 3, 13, 1, 11] [17, 3, 13, 1, 11]
    poll: 17
    [3, 13, 1, 11] [3, 13, 1, 11]
    =======================================
    [3, 13, 1, 11, 13] [3, 13, 1, 11, 13]
    [3, 13, 1, 11, 13, 13] [3, 13, 1, 11, 13, 13]
    [3, 13, 1, 11, 13, 13, 0] [3, 13, 1, 11, 13, 13, 0]
    [3, 13, 1, 11, 13, 13, 0, 7] [3, 13, 1, 11, 13, 13, 0, 7]
    [3, 13, 1, 11, 13, 13, 0, 7, 17] [3, 13, 1, 11, 13, 13, 0, 7, 17]
    =======================================
    [3, 13, 1, 11, 13, 13, 0, 7, 17] [3, 13, 1, 11, 13, 13, 0, 7, 17]
    poll: 3
    [13, 1, 11, 13, 13, 0, 7, 17] [13, 1, 11, 13, 13, 0, 7, 17]
    =======================================
    13
    1
    11
